...
def poc(url):
    ...
    webshell_path = []
    if linux_check_1(url, webshell_path) == True:
        return True
    elif(linux_check_2(url, webshell_path) == True):
        return True
    elif(windows_check_1(url, webshell_path) == True):
        return True
    elif(windows_check_2(url, webshell_path) == True):
        return True
    else:
        return False
